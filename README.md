...
### ### How It Works
1.  **Ingest:** Raw service reports are fed into the system.
2.  **Analyze:** The pipeline identifies technical keywords (e.g., "Error 404," "Sensor Replacement," "Calibration").
3.  **Structure:** Extracted data is mapped to specific fields: `Machine_ID`, `Fault_Type`, `Resolution`, and `Date`.
4.  **Query:** Users can search the database to find patterns in equipment failure across multiple hospital sites.
